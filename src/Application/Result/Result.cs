...
public class Result 
{
    ...
    /// <returns></returns>
    public static Result<TResult> Success<TResult>(TResult? resultValue = default) => new Result<TResult>() {Succeed = true, ResultValue = resultValue};
    /// <summary>
    ...
    /// <param name="resultValue"></param>
    /// <returns></returns>
    public static Result<TResult> Failed<TResult>(TResult? resultValue = default) => new Result<TResult>() {Succeed = false, ResultValue = resultValue};
